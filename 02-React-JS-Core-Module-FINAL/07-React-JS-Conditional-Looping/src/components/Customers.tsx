...
import { CustomerStore, type ICustomer, } from "./CustomerStore";

const Customers: React.FC = () => {
    const [customers] = useState<ICustomer[]>(CustomerStore.customerData);
                ...
                <div className="row">
                    <div className="col">
                        ...
                        <p>
                            ...
                            Alias aliquam, beatae cumque delectus dolores eveniet itaque 
                            maxime molestiae nemo nulla pariatur perferendis ratione rem 
                            repellat similique, sint sit temporibus veritatis.
                        </p>
                    </div>
                </div>
                <div className="row">
