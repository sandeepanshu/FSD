...
const ProductItem: React.FC = () => {
  ...
  const decrQty = () => {
    setProduct({ ...product, qty: product.qty > 1 ? product.qty - 1 : 1 });
  };
          ...
          <div className="row">
            <div className="col">
              ...
              <p>
                ...
                Error et exercitationem fuga, nobis qui quo totam voluptas
                voluptatem? Ad architecto earum id natus officia quia
                reprehenderit rerum soluta vero voluptates.
              </p>
            </div>
          </div>
        </div>
