...
import { incrProductQty, decrProductQty, deleteCartProduct } from '../../../../redux/orders/order.slice';
...
const Cart: React.FC = () => {
    ...
    const { loading, cartItems } = useSelector((state: RootState) => state.orders);
                                                        ...
                                                        <tr key={cartItem._id}>
                                                            ...
                                                            <td className="align-middle">
                                                                <div className="product-info">
                                                                    <h6 className="product-name">{cartItem.name}</h6>
                                                                    <span className="product-brand">{cartItem.brand}</span>
                                                                </div>
                                                            </td>
                                                            <td className="align-middle">
                                                            ...
                                                            <td className="align-middle">
                                                                <div className="quantity-controls">
                                                                    <button 
                                                                        className="qty-btn"
                                                                        onClick={() => clickDecrQty(cartItem._id)}
                                                                    ...
                                                                    <button 
                                                                        className="qty-btn"
                                                                        onClick={() => clickIncrQty(cartItem._id)}
                                                            ...
                                                            <td className="align-middle">
                                                                <button 
                                                                    ...
                                                                    onClick={() => clickDeleteProduct(cartItem._id)}
                                                                    title="Remove item"
                                                                >
