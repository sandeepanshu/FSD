...
import { getMenProductsCollection } from "../../../../redux/products/product.slice";
...
const MensCollection: React.FC = () => {
  ...
  useEffect(() => {
    dispatch(getMenProductsCollection());
  }, [dispatch]);
          ...
          <div className="breadcrumb-section">
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb">
                ...
                <li className="breadcrumb-item active">Men's Collection</li>
              </ol>
            </nav>
          </div>
          <div className="header-text">
            <h1 className="collection-title">
              <i className="fas fa-male"></i> Men's Collection
            </h1>
            <p className="collection-subtitle">
              Discover trending styles for the modern man
            </p>
          </div>
        </div>
      </section>
